...
def make_env(env_name, test, seed=0, terminate_at_any_goal=False, split_obs=False, user_goal='target', **kwargs):
    ...
    if "LunarLander" in env_name:
        ...
        # Import lazily so LunarLander/Maze runs do not require the TensorFlow stack.
        from diffusha.data_collection.env.block_pushing import block_pushing_multimodal_1block  # noqa: F401
