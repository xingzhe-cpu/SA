...
def worker(remote, env_fn):
    ...
    output_dir = os.environ.get("RMX_OUTPUT_DIR")
    if output_dir:
        os.makedirs(output_dir, exist_ok=True)
        sys.stdout = open(os.path.join(output_dir, str(os.getpid()) + ".out.txt"), "a")
        sys.stderr = open(
            os.path.join(output_dir, str(os.getpid()) + "_error.out.txt"), "a"
        )
